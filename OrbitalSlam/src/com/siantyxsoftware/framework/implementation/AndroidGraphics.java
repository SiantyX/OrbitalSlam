...
public class AndroidGraphics implements Graphics {
    ...
    public int getCenterWidth() {
    	return frameBuffer.getWidth()/2;
    }
    
    @Override
    public int getCenterHeight() {
    	return frameBuffer.getHeight()/2;
    }
    
    @Override
    public void drawCenterString(String text, int x, int y, Paint paint) {
    	x = Math.round((x - paint.measureText(text)/2));
    	y = Math.round(y + paint.getTextSize()/2);
