...
public class ViewPort {
	...
	public void drawStringCenter(TrueTypeFont font, String text, Vector2f v,
			int width) {
		v = toRelative(v);
		FontUtils.drawCenter(font, text, Math.round(v.x), Math.round(v.y),
				width);
	}
	...
	public void drawString(Graphics g, TrueTypeFont font, String text,
			Vector2f v) {
		g.setFont(font);
		v = toRelative(v);
